...
const GradientHero = () => {
  return (
  <section className="relative flex items-center justify-center overflow-hidden px-4 md:px-6 min-h-screen">
      ...
      <div className="container relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-2 lg:gap-6 items-start">
        ...
        <div className="flex justify-center w-full max-w-[95vw] lg:max-w-full mx-auto -mt-4 lg:mt-0">
          <GradientGridHero />
        </div>
      </div>
